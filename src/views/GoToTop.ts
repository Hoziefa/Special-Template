...
export class GoToTop extends View {
    public readonly selectors: Record<keyof IGoToTopElements, string> = { gotoTop: '.goto-top' };

    public get elements(): IGoToTopElements {
    ...
    protected eventsMap(): { [p: string]: EventListener } {
        ...
        return { [`click:${ gotoTop }`]: (): void => document.documentElement.scrollIntoView({ behavior: 'smooth' }), 'scroll:html': this.toggleGoTopBtnDisplay };
    }
